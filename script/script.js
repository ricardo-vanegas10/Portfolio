...
document.addEventListener('DOMContentLoaded', function () {
    ...
    inglesLink.addEventListener('click', function (event) {
        ...
        function cambiarIdioma(idioma) {
            // Implementa aquí la lógica específica para cambiar el idioma en tu aplicación
            // Puedes cargar archivos de idioma, cambiar clases, etc.
            ...
            if (idioma === 'espanol') {
                ...
                <p>Ingeniero civil con experiencia en principios y normas de ingeniería, habilidades en cálculos,
                    interpretación de planos y supervisión de obra. Además, tengo sólidos conocimientos como
                    desarrollador web para la creación de sitios webs dinámicos. Destaco por mi liderazgo y resolución
                    de problemas.</p>
            `;
...
`;
                    ...
                    <div class="carousel-inner">
                      ...
                      <div class="carousel-item ageapp">
                        ...
                        <div class="carousel-caption">
                          ...
                          <p class="text-dark"><strong>Una calculadora básica que calcula la edad en días, meses y años</strong></p>
                        </div> 
                      </div>
                      <div class="carousel-item hivley">
                        ...
                        <div class="carousel-caption">
                          ...
                          <p><strong>Un proyecto básico de HTML, CSS y Javascript usando Tailwind</strong></p>
                        </div>  
                      </div>
                      <div class="carousel-item homepage">
                        <img src="./img/homepage-main.png" alt="Homepage main" class="d-block" style="width:100%">
                        <div class="carousel-caption">
                          <h3 class="text-dark"><a href="https://ricardo-vanegas10.github.io/new-homepage-main/" target="_blank">Página de inicio principal</a></h3>
                          <p class="text-dark"><strong>Página responsiva usando Bootstrap</strong></p>
                        </div>  
                      </div>
                      <div class="carousel-item metaverse">
                        <img src="./img/metaverse.png" alt="Metaverse" class="d-block" style="width:100%">
                        <div class="carousel-caption">
                          <h3><a href="https://ricardo-vanegas10.github.io/Metaverse/" target="_blank">Metaverso</a></h3>
                          <p><strong>Proyecto básico creado con HTML, CSS y Bootstrap</strong></p>
                        </div>  
                      </div>
                      <div class="carousel-item netflix">
                        ...
                        <div class="carousel-caption">
                          ...
                          <p class="text-white"><strong>Un proyecto básico usando HTML, CSS y Javascript</strong></p>
                        </div>  
                      </div>
                    </div>
                ...
                introduceElement.innerHTML = `
                    ...
                    <p>Civil engineer with experience in engineering principles and standards, skills in calculations,
                        interpretation of plans, and site supervision. Additionally, I have strong knowledge as a web
                        developer for creating dynamic websites. I stand out for my leadership and problem-solving
                        skills.</p>
                `;
            ...
            <h3 class="my-4 bg-dark text-white text-center skills">Skills</h3>
            <ul class="d-flex gap-2 skills">
                <li>
                    <a href="https://getbootstrap.com" target="_blank" rel="noreferrer">
                        <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/bootstrap/bootstrap-plain-wordmark.svg"
                ...
                <div id="demo" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      ...
                      <div class="carousel-item hivley">
                        ...
                        <div class="carousel-caption">
                          <h3><a href="https://ricardo-vanegas10.github.io/Hivley/" target="_blank">Hivley</a></h3>
                          <p><strong>A basic HTML, CSS and Javascript project using Tailwind</strong></p>
                        </div>  
                      </div>
                      <div class="carousel-item homepage">
                        <img src="./img/homepage-main.png" alt="Homepage main" class="d-block" style="width:100%">
                        <div class="carousel-caption">
                          ...
                          <p class="text-dark"><strong>Responsive main page using Bootstrap</strong></p>
                        </div>  
                      </div>
                      <div class="carousel-item metaverse">
                        <img src="./img/metaverse.png" alt="Metaverse" class="d-block" style="width:100%">
                        <div class="carousel-caption">
                          ...
                          <p><strong>Basic project created with HTML, CSS and Bootstrap</strong></p>
                        </div>  
                      </div>
                      <div class="carousel-item netflix">
                        <img src="./img/netflix.png" alt="Netflix" class="d-block" style="width:100%">
                        <div class="carousel-caption">
                          <h3><a href="https://ricardo-vanegas10.github.io/Netflix/" target="_blank">Netflix</a></h3>
                          <p class="text-white"><strong>A basic project using HTML, CSS and Javascript</strong></p>
                        </div>  
                      </div>
                    </div>
